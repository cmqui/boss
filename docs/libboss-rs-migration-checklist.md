...
This checklist tracks the remaining work to finish the migration to Rust `libboss` and remove the deprecated Swift implementation. It replaces the older phase list that was written while `packages/libboss` still referred to the Swift package.

## Current Repo Snapshot

- `packages/libboss` is now the Rust workspace and the intended source of truth for protocol, codec, and session logic.
  Files:
  [packages/libboss/README.md](/Users/ciara/Code/boss/packages/libboss/README.md:1)
  [packages/libboss/Cargo.toml](/Users/ciara/Code/boss/packages/libboss/Cargo.toml:1)

- The old Swift implementation now lives in `packages/libboss-OLD` and is explicitly deprecated.
  Files:
  [packages/libboss-OLD/README.md](/Users/ciara/Code/boss/packages/libboss-OLD/README.md:1)
  [packages/libboss-OLD/Package.swift](/Users/ciara/Code/boss/packages/libboss-OLD/Package.swift:1)
...
- `libboss-apple` no longer has a SwiftPM dependency on the old Swift package. Its only package dependency is the local C target used to talk to the Rust FFI.
  Files:
  [packages/libboss-apple/Package.swift](/Users/ciara/Code/boss/packages/libboss-apple/Package.swift:1)
...
- `bossctl`, `boss-macos`, `boss-apple-app`, and `boss-ios` all consume `libbossApple` or `BossAppleApp`; none of the active app or CLI targets import the deprecated Swift `libboss` module directly.
  Files:
  [packages/bossctl/Package.swift](/Users/ciara/Code/boss/packages/bossctl/Package.swift:1)
  [packages/boss-macos/Package.swift](/Users/ciara/Code/boss/packages/boss-macos/Package.swift:1)
  [packages/boss-apple-app/Package.swift](/Users/ciara/Code/boss/packages/boss-apple-app/Package.swift:1)
  [packages/boss-ios/BossiOS.xcodeproj/project.pbxproj](/Users/ciara/Code/boss/packages/boss-ios/BossiOS.xcodeproj/project.pbxproj:1)

## Exit Criteria

- `libboss-apple`, `bossctl`, `boss-macos`, `boss-apple-app`, and `boss-ios` no longer depend on any source from `packages/libboss-OLD`.
...
- [x] Make Rust `libboss` the active source of truth for protocol/session logic.
  Result:
  The active `packages/libboss` directory is the Rust workspace, while the legacy Swift code was moved aside to `packages/libboss-OLD`.
  Files:
  [packages/libboss/README.md](/Users/ciara/Code/boss/packages/libboss/README.md:1)
  [packages/libboss-OLD/README.md](/Users/ciara/Code/boss/packages/libboss-OLD/README.md:1)
...
- [x] Remove Swift-session fallback ownership from `libboss-apple`.
  ...
  Files:
  [packages/libboss-apple/Sources/libbossApple/BossAppleSession.swift](/Users/ciara/Code/boss/packages/libboss-apple/Sources/libbossApple/BossAppleSession.swift:1)
  [packages/libboss-apple/Sources/libbossApple/BossRustSessionBridge.swift](/Users/ciara/Code/boss/packages/libboss-apple/Sources/libbossApple/BossRustSessionBridge.swift:1)
...
- [x] Route packet encode/decode and BLE framing through Rust-owned helpers.
  ...
  Files:
  [packages/libboss-apple/Sources/libbossApple/BossAppleLink.swift](/Users/ciara/Code/boss/packages/libboss-apple/Sources/libbossApple/BossAppleLink.swift:1)
  [packages/libboss-apple/Sources/libbossApple/RustBridge/BossRustSessionBridge+Transport.swift](/Users/ciara/Code/boss/packages/libboss-apple/Sources/libbossApple/RustBridge/BossRustSessionBridge+Transport.swift:1)
  [packages/libboss-apple/Sources/libbossApple/RustBridge/BossRustCodecBridge.swift](/Users/ciara/Code/boss/packages/libboss-apple/Sources/libbossApple/RustBridge/BossRustCodecBridge.swift:1)
...
- [x] Re-home shared Bose BLE constants into `libboss-apple`.
  ...
  Files:
  [packages/libboss-apple/Sources/libbossApple/AppleBoseUUIDs.swift](/Users/ciara/Code/boss/packages/libboss-apple/Sources/libbossApple/AppleBoseUUIDs.swift:1)
  [packages/libboss-apple/Sources/libbossApple/AppleBleBossTransport.swift](/Users/ciara/Code/boss/packages/libboss-apple/Sources/libbossApple/AppleBleBossTransport.swift:1)
  [packages/libboss-apple/Sources/libbossApple/AppleBossDeviceDiscovery.swift](/Users/ciara/Code/boss/packages/libboss-apple/Sources/libbossApple/AppleBossDeviceDiscovery.swift:1)
...
- [x] Stop exposing old Swift-core transport/session types from the Apple layer.
  ...
  Files:
  [packages/libboss-apple/Sources/libbossApple/BossAppleController.swift](/Users/ciara/Code/boss/packages/libboss-apple/Sources/libbossApple/BossAppleController.swift:1)
...
- [x] Move app- and CLI-facing type usage onto `libbossApple`.
  ...
  Files:
  [packages/bossctl/Sources/bossctl/Main.swift](/Users/ciara/Code/boss/packages/bossctl/Sources/bossctl/Main.swift:1)
  [packages/boss-macos/Sources/BossMacOS/ContentView.swift](/Users/ciara/Code/boss/packages/boss-macos/Sources/BossMacOS/ContentView.swift:1)
  [packages/boss-apple-app/Sources/BossAppleApp/BossAppViewModel.swift](/Users/ciara/Code/boss/packages/boss-apple-app/Sources/BossAppleApp/BossAppViewModel.swift:1)
  [packages/boss-ios/Sources/BossiOS/BossIOSRootView.swift](/Users/ciara/Code/boss/packages/boss-ios/Sources/BossiOS/BossIOSRootView.swift:1)
...
- [x] Decide whether any public `BossApple...` compatibility shims should be simplified further.
  ...
  Files:
  [packages/libboss-apple/Sources/libbossApple/BossApplePublicTypes.swift](/Users/ciara/Code/boss/packages/libboss-apple/Sources/libbossApple/BossApplePublicTypes.swift:1027)
  [packages/libboss-apple/Sources/libbossApple/BossAppleController.swift](/Users/ciara/Code/boss/packages/libboss-apple/Sources/libbossApple/BossAppleController.swift:230)
  [packages/libboss-apple/Sources/libbossApple/BossAppleSession.swift](/Users/ciara/Code/boss/packages/libboss-apple/Sources/libbossApple/BossAppleSession.swift:108)
...
- [x] Remove direct source imports of the deprecated Swift `libboss` module from active products.
  Result:
  The remaining `@testable import libboss` references are confined to `packages/libboss-OLD/Tests`.
  Files:
  [packages/libboss-OLD/Tests/libbossTests/libbossTests.swift](/Users/ciara/Code/boss/packages/libboss-OLD/Tests/libbossTests/libbossTests.swift:1)
  [packages/libboss-OLD/Tests/libbossTests/BossSettingsSnapshotTests.swift](/Users/ciara/Code/boss/packages/libboss-OLD/Tests/libbossTests/BossSettingsSnapshotTests.swift:1)
...
- [x] Remove direct `libboss` usage from `bossctl`.
  ...
  Files:
  [packages/bossctl/Sources/bossctl](/Users/ciara/Code/boss/packages/bossctl/Sources/bossctl:1)
...
- [x] Remove direct `libboss` usage from `boss-macos`.
  ...
  Files:
  [packages/boss-macos/Sources/BossMacOS](/Users/ciara/Code/boss/packages/boss-macos/Sources/BossMacOS:1)
...
- [x] Keep shared app logic on top of the Apple layer.
  ...
  Files:
  [packages/boss-apple-app/Sources/BossAppleApp](/Users/ciara/Code/boss/packages/boss-apple-app/Sources/BossAppleApp:1)
  [packages/boss-ios/Sources/BossiOS](/Users/ciara/Code/boss/packages/boss-ios/Sources/BossiOS:1)
...
- [x] Narrow opportunistic `dlopen` probing to an explicit supported search policy.
  ...
  Files:
  [packages/libboss-apple/Sources/libbossApple/RustBridge/BossRustSessionBridge+Runtime.swift](/Users/ciara/Code/boss/packages/libboss-apple/Sources/libbossApple/RustBridge/BossRustSessionBridge+Runtime.swift:1)
  [packages/libboss-apple/README.md](/Users/ciara/Code/boss/packages/libboss-apple/README.md:1)
...
- [x] Unify or intentionally document the current macOS and iOS linkage split.
  ...
  Files:
  [packages/boss-macos/project.yml](/Users/ciara/Code/boss/packages/boss-macos/project.yml:1)
  [packages/boss-macos/scripts/build-libboss-ffi.sh](/Users/ciara/Code/boss/packages/boss-macos/scripts/build-libboss-ffi.sh:1)
  [packages/boss-ios/project.yml](/Users/ciara/Code/boss/packages/boss-ios/project.yml:1)
  [packages/boss-ios/scripts/build-libboss-ffi.sh](/Users/ciara/Code/boss/packages/boss-ios/scripts/build-libboss-ffi.sh:1)
  [packages/libboss-apple/README.md](/Users/ciara/Code/boss/packages/libboss-apple/README.md:1)
...
- [x] Keep Rust crate tests in place for the Rust source of truth.
  ...
  Files:
  [packages/libboss/libboss-core/tests/core_parity.rs](/Users/ciara/Code/boss/packages/libboss/libboss-core/tests/core_parity.rs:1)
  [packages/libboss/libboss-session/src/tests.rs](/Users/ciara/Code/boss/packages/libboss/libboss-session/src/tests.rs:1)
  [packages/libboss/libboss-ffi/src/tests.rs](/Users/ciara/Code/boss/packages/libboss/libboss-ffi/src/tests.rs:1)
...
- [x] Swift-side bridge and public-API coverage now make the Rust-first cutover deletion-safe.
  ...
  Files:
  [packages/libboss-apple/Tests/libbossAppleTests](/Users/ciara/Code/boss/packages/libboss-apple/Tests/libbossAppleTests:1)
...
- [x] Downstream Apple-layer consumers already have basic unit coverage.
  Files:
  [packages/bossctl/Tests/bossctlTests](/Users/ciara/Code/boss/packages/bossctl/Tests/bossctlTests:1)
  [packages/boss-apple-app/Tests/BossAppleAppTests](/Users/ciara/Code/boss/packages/boss-apple-app/Tests/BossAppleAppTests:1)
...
- [ ] Freeze `packages/libboss-OLD` as archival-only code until the remaining runtime/test/hardware items are done.

- [ ] Keep `packages/libboss-OLD` archived in place with no active product dependencies, no new feature work, and clear documentation that it is retained for reference only.
...
- [ ] Clean up any docs, scripts, or comments that still speak about migrating from Swift `libboss` as if the active package had not already moved to Rust.
  Files:
  [packages/libboss-apple/README.md](/Users/ciara/Code/boss/packages/libboss-apple/README.md:1)
  [packages/boss-macos/README.md](/Users/ciara/Code/boss/packages/boss-macos/README.md:1)
...
- [ ] 5. Lock `packages/libboss-OLD` into archival-only status and clean up migration-era documentation.
