...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Boss",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC4Boss11AppDelegate")
...
@class NSWindow;
@interface AppDelegate (SWIFT_EXTENSION(Boss)) <NSWindowDelegate>
